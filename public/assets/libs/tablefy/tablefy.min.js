var FuncionesUtiles = {
  ...
  function Tablefy (params) {
    ...
    _instance.privado = {
      ...
      init: function(x) {
        ...
        if(typeof parametros.theme === 'undefined') {
          ...
          if(true) {
            ...
            html_header += "<div class=\"tablefy_extra_buttons\"></div>";
            if((typeof parametros.search == 'undefined' || parametros.search == true)) {
              html_header += "<div class=\"tablefy_search search-box\"><input type=\"text\" id=\"textq\" class=\"form-control  search\" placeholder=\"Buscar\.\.\.\"><i class=\"ri-search-line search-icon\"></i></div>";
            ...
            if((typeof parametros.refresh == 'undefined' || parametros.refresh == true)) {
        ...
        if(typeof parametros.tocallrefresh !== 'undefined' && !FuncionesUtiles.empty(parametros.tocallrefresh)) {
          console.log('Definiendo la funcion: ', parametros.tocallrefresh);
          window[parametros.tocallrefresh] = function() {
            _instance.privado.refresh();
          };
        }
        //setTimeout(function() {// TODO
          _instance.privado.inicializarTabla();
          if(!FuncionesUtiles.empty(parametros.start)) {
            _instance.privado.refresh();
          }
        //}, 500);
        ...
        if(!FuncionesUtiles.empty(ls)) {
          for(var index in ls) {
            if(ls.hasOwnProperty(index)) {
              ...
              if(typeof ls[index].attrs !== 'undefined') {
                html.find('a').attr(ls[index].attrs);
              }
            }
          }
        }
      ...
      inicializarTabla: function() {
        ...
        elementosTablefy.header.find("thead tr.title div.title").text(parametros.title);
        if(typeof parametros.draggable !== 'undefined' && parametros.draggable == true) { //
  ...
  //          }, 500);
        ...
        elementosTablefy.header.on("contextmenu", "tbody>tr[data-id]", function(e) {
          e.preventDefault();
        ...
        elementosTablefy.tableBodyContent.on("dblclick", "tr>td[data-xeditable=true]", function(e) {
          let td = $(this);
...
//          thead.append($('<th>').css({ width: 30, 'max-width': 30}));
      ...
      volcarContenido: function(contenido, append, offReady) {
        ...
        if(contenido.success == false) {
          _instance.privado.block(true, contenido.message);
          return;
        } else {
          _instance.privado.block(false);
        }
  ...
  //      _instance.privado.refreshOptions();
      ...
      refresh: function(xx) {
        ...
        var ipns = {};
        if(typeof parametros.tocallinject !== 'undefined' && !FuncionesUtiles.empty(parametros.tocallinject)) {
          if(typeof window[parametros.tocallinject] !== 'undefined') {
            ipns = window[parametros.tocallinject]();
          }
        }
        $.ajax({
