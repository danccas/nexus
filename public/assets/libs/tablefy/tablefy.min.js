var FuncionesUtiles = {
  ...
  function Tablefy (params) {
    ...
    _instance.privado = {
      ...
      init: function(x) {
        ...
        var estructura = "<ul class=\"tablefy_menu\" style=\"display:none;\"></ul><div class=\"tablefy_loading\">Cargando...<br><img src=\"/assets2/img/tools/loading/loader.gif\"></div><div class=\"tablefy_block\"></div><div class=\"tablefy_tables\">";
        ...
        if(typeof parametros.theme === 'undefined') {
          estructura += "<div class=\"tablefy_overflow\" style=\"width:100%;/*background:#E8F5FF*/;overflow-y: auto;" + styleContentBody + "\"><div class=\"tablefy_rulertime\"></div>";
        ...
        if(typeof parametros.theme === 'undefined') {
          ...
          if(typeof parametros.search == 'undefined' || parametros.search == true){
            ...
            html_header += "<div class=\"tablefy_extra_buttons\"></div><div class=\"tablefy_search search-box\"><input type=\"text\" id=\"textq\" class=\"form-control bg-light  search\" placeholder=\"Buscar\.\.\.\"><i class=\"ri-search-line search-icon\"></i></div>";
  ...
  //      }
      ...
      refreshOptions: function () {
        ...
        elementosTablefy.footer.find("tfoot>tr>td .tablefy_pagination .current_page").text('Página ' + _instance.current_page).on('click', function () {
          _instance.privado.refresh()
        });
